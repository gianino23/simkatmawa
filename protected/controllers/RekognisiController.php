...
class RekognisiController extends Controller
{
	...
	public function actionTambah()
	{
		...
		$model->identitas = $_POST['modal_identitas'];
		$model->institusi = $_POST['modal_institusi'];
		...
		if($model->save())
		 {
		  ...
		  $content = file_get_contents(Yii::app()->createAbsoluteUrl('rekognisi/adminn'), true);
	...
	public function actionEdit($id)
	{
		...
		if(isset($_POST['Rekognisi']))
		{
			$model->attributes=$_POST['Rekognisi'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->id_rekognisi));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Rekognisi');
	...
	{
		$model=new Rekognisi('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Rekognisi']))
			$model->attributes=$_GET['Rekognisi'];
	 ...
	 * @return Rekognisi the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Rekognisi::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Rekognisi $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='rekognisi-form')
		{
