...
<?php
	$p = Belanegara::model()->findByAttributes(array('id_belanegara'=>$id),array('order'=>'id_belanegara ASC'));
?>
				...
				<div class="row">
					<div class="col-12">
						<div class="float-left">
							<h3 class="card-title">Halaman Detail Bela Negara</h3>
							<h6 class="card-subtitle">Deskripsi Halaman Detail Bela Negara</h6>
						</div>
					...
					<div class="col-6">
					<h4>Nama Program Bela Negara</h4>
					<p><?= $p->nama_program; ?></p>
					</div>
					<div class="col-6">
					<h4>Judul Kegiatan dan Topik Kegiatan</h4>
					<p><?= $p->judul; ?></p>
					</div>
					<div class="col-4">
