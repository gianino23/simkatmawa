							...
							<div id="tambahData" class="modal fade" tabindex="-1" role="dialog"
                                ...
                                <div class="card-body">
									...
									<div class="form-group row align-items-center mb-0">
                                        ...
                                        <div class="col-md-9 border-left pb-2 pt-2">
                                            <select name="modal_staus" id="modal-status" class="form-control select2" style="width: 100%;" required>
												<option value="" selected="selected">-- Pilih Satu --</option>
									...
									<div class="form-group row align-items-center mb-0">
                                        ...
                                        <div class="col-md-9 border-left pb-2 pt-2">
                                           <input type="file" name="modal_fileupload" id="modal-fileupload" class="form-control" />
                                        </div>
                                    </div>
                                 <br>
