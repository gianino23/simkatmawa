...
<div class="row page-titles">
	<div class="col-md-5 col-12 align-self-center">
		...
		<ol class="breadcrumb mb-0">
			...
			<li class="breadcrumb-item active">Luaran Kinerja</li>
		</ol>
	</div>
	<!--
				...
				<div class="row">
					<div class="col-12">
						<div class="float-left">
							<h3 class="card-title">Halaman Luaran Kinerja</h3>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myModalLabel">Tambah Data Luaran Kinerja</h4>
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-hidden="true">×</button>
                                            </div>
                                            <div class="modal-body">
                                <form id="form-save" class="form-horizontal r-separator" name="modal_popup" action="?r=luarankinerja/tambah" method="POST" enctype='multipart/form-data'>
                                <div class="card-body">
...
<script type="text/javascript">
  ...
  $("#delete_link").on("click", function(){
   ...
   $.ajax({
    ...
    url: '?r=luarankinerja/hapus',  // untuk mendapatkan attribut action pada form
    data: { 
     id: id
    },
    success:function(response){
