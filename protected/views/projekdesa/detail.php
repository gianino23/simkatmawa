...
<?php
	$p = Projekdesa::model()->findByAttributes(array('id_projekdesa'=>$id),array('order'=>'id_projekdesa ASC'));
?>
				...
				<div class="row">
					<div class="col-12">
						<div class="float-left">
							<h3 class="card-title">Halaman Detail Projek di Desa</h3>
							<h6 class="card-subtitle">Deskripsi Halaman Detail Projek di Desa</h6>
						</div>
					...
					<div class="col-6">
					<h4>Nama Program / Projek Pembangunan di Desa</h4>
					<p><?= $p->nama_program; ?></p>
					</div>
					<div class="col-6">
					<h4>Judul Program</h4>
