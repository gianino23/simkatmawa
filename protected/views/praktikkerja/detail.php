...
<?php
	$p = Praktikkerja::model()->findByAttributes(array('id_praktikkerja'=>$id),array('order'=>'id_praktikkerja ASC'));
?>
				...
				<div class="row">
					<div class="col-12">
						<div class="float-left">
							<h3 class="card-title">Halaman Detail Praktik Kerja / Magang</h3>
							<h6 class="card-subtitle">Deskripsi Halaman Detail Praktik Kerja / Magang</h6>
						</div>
					...
					<div class="col-6">
					<h4>Nama Program Magang / Praktik Kerja</h4>
					<p><?= $p->nama_program; ?></p>
					</div>
					<div class="col-6">
					<h4>Lokasi Magang</h4>
					...
					<div class="col-6">
					<h4>Waktu Pelaksanaan Magang</h4>
					<p><?= $p->tanggal; ?></p>
					</div>
					<div class="col-6">
					<h4>Jumlah Mahasiswa Magang</h4>
					<p><?= $p->jml_mhs_magang." Orang"; ?></p>
					</div>
