...
<div class="row page-titles">
    ...
    <div class="col-md-7 col-12 align-self-center d-none d-md-block">
        ...
        <?= CHtml::link('Export Excel',array('projekkemanusian/export'),array('class'=>'btn waves-effect waves-light btn-excel')) ?>
...
<div class="container-fluid">
	...
	<div class="col-12">
		...
		<div class="card">
            ...
            <h3 class="card-title text-white">Halaman Projek Kemanusiaan</h3>
</div>
			<div class="card-body">
				<div class="row">
					<div class="col-12">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myModalLabel">Tambah Data Projek Kemanusiaan</h4>
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-hidden="true">×</button>
                                            </div>
                                            <div class="modal-body">
                                <form id="form-save" class="form-horizontal r-separator" name="modal_popup" action="?r=projekkemanusian/tambah" method="POST" enctype='multipart/form-data'>
                                <div class="card-body">
                                    <div class="form-group row align-items-center mb-0">
                                        <label for="inputUsername3"
                                            class="col-md-3 text-right control-label col-form-label">Nama Program</label>
...
<script type="text/javascript">
  ...
  let id_projekkemanusian = $(this).data('id');
  $('#modal_delete').modal('show', {backdrop: 'static'});
  $("#delete_link").on("click", function(){
   e.preventDefault();
   $.ajax({
    method:  'POST', // untuk mendapatkan attribut method pada form
    url: '?r=projekkemanusian/hapus',  // untuk mendapatkan attribut action pada form
    data: { 
     id_projekkemanusian: id_projekkemanusian
    },
    success:function(response){
	//console.log(response);
     $("#modal-data").empty();
