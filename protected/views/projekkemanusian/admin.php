				...
				<div class="row">
					<div class="col-12">
						<div class="float-left">
							<h3 class="card-title">Halaman Projek Kemanusiaan</h3>
							<h6 class="card-subtitle">Deskripsi Halaman Projek Kemanusiaan</h6>
						</div>
						<div class="float-right">
						 <button type="button" class="btn waves-effect waves-light btn-success" data-toggle="modal" data-target="#tambahData">Tambah Data</button>
						  <a href="?r=projekkemanusian/export" type="button" class="btn waves-effect waves-light btn-danger" >Export Excel</a>
						</div>
					</div>
					<div class="col-12">
