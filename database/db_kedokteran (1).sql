...
--
-- Host: localhost:3306
-- Generation Time: Nov 16, 2021 at 04:16 AM
...
(1, 2, '<p>asdasdasd</p>', '<p>asdasd</p>', '<p>asdasd</p>', 5);
...
(16, 'Festival Jukung Hias 2022', 0);
...
INSERT INTO `t_galery` (`id_galery`, `judul`, `deskripsi`, `folder`, `file`, `tgl_entry`) VALUES
(16, 'Screen Shot 2021-06-25 at 09.07.51.png', '', 16, 'Screen Shot 2021-06-25 at 09.07.51.png', '2021-11-03');
...
--
-- Table structure for table `t_luarankinerja`
--

CREATE TABLE `t_luarankinerja` (
  `id` int(11) NOT NULL,
  `ormas_id` int(11) DEFAULT NULL,
  `file` text,
...
(6, 1, '<p>123123asdasdjkh ajsdh kjahdkjahkjaskjadsk</p>', 5),
(8, 2, '<!DOCTYPE html PUBLIC \"-//W3C//DTD HTML 4.0 Transitional//EN\" \"http://www.w3.org/TR/REC-html40/loose.dtd\">\n<html><body><p><img src=\"upload/profil/forum_img_617fda3bb432d784857343.png\" style=\"width: 514px;\" data-original-filename=\"screencapture-revacovid19-kalselprov-go-id-2021-09-10-13_48_23.png\"><br></p></body></html>\n', 5);
...
(5, 2, 5, 2, 'asdnakjsdnakjnsd asjnd kjasdjknaskjdasjldalksjd klajsdkl ajsdlk jadsklajd', '2021-10-13 04:44:00', 1, '-'),
(6, 2, 5, 1, 'Rapat AUIEO', '2021-11-19 18:53:00', 1, '-');
...
--
-- Dumping data for table `t_regulasimhs`
--
...
(8, 4, '28820909.pdf', 1, 5, '2021-10-31 00:00:00'),
(9, 5, '79991087.pdf', 1, 5, '2021-10-31 00:00:00');
...
INSERT INTO `t_slide` (`id_slide`, `judul`, `subjudul`, `file`, `urutan`, `status`) VALUES
(1, 'Judul 1', 'Sub 1', 'Screen Shot 2021-06-09 at 08.30.52.png', 1, 1),
(2, 'Judul 2', 'sub 2', 'Three-Swans.mp4', 2, 1);
...
(2, '2021-10-30', '::1', '1', 'Chrome/Opera'),
(3, '2021-10-30', '::1', '1', 'Chrome/Opera'),
(4, '2021-10-31', '::1', '1', 'Chrome/Opera'),
(5, '2021-10-31', '::1', '1', 'Chrome/Opera'),
(6, '2021-10-31', '::1', '1', 'Chrome/Opera'),
(7, '2021-10-31', '::1', '1', 'Chrome/Opera'),
(8, '2021-10-31', '::1', '1', 'Chrome/Opera'),
(9, '2021-10-31', '::1', '1', 'Chrome/Opera'),
(10, '2021-10-31', '::1', '1', 'Chrome/Opera'),
(11, '2021-10-31', '::1', '1', 'Chrome/Opera'),
(12, '2021-11-01', '::1', '1', 'Chrome/Opera'),
(13, '2021-11-01', '::1', '1', 'Chrome/Opera'),
(14, '2021-11-01', '::1', '1', 'Chrome/Opera'),
(15, '2021-11-01', '::1', '1', 'Chrome/Opera'),
(16, '2021-11-03', '::1', '1', 'Safari'),
(17, '2021-11-03', '127.0.0.1', '1', 'Firefox'),
(18, '2021-11-11', '::1', '1', 'Safari'),
(19, '2021-11-11', '::1', '1', 'Safari'),
(20, '2021-11-12', '::1', '1', 'Safari'),
(21, '2021-11-12', '::1', '1', 'Safari'),
(22, '2021-11-16', '::1', '1', 'Safari'),
(23, '2021-11-16', '::1', '1', 'Safari'),
(24, '2021-11-16', '::1', '1', 'Safari'),
(25, '2021-11-16', '::1', '1', 'Safari');
...
--
-- Indexes for table `t_luarankinerja`
--
ALTER TABLE `t_luarankinerja`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `t_luarankinerja`
--
ALTER TABLE `t_luarankinerja`
...
--
ALTER TABLE `t_regulasimhs`
  MODIFY `id_regulasimhs` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `t_visitor`
  MODIFY `id_visitor` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
